...
<body>
    ...
    <div >
        <?php 
            ...
            $query = "SELECT * FROM cohesionFund";
            echo "<b> <center>Applicants for Campus Cohesion Fund</center> </b> <br> <br>";
             ...
             echo '<table class="table" border="0" cellspacing="2" cellpadding="2">
                  <thead class="thead-dark">
                    <tr>
                      ...
                      <th scope="col"><font face="Arial">Project Name</font></th>
            ...
            if ($result = mysqli_query($conn, $query)) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    $field8name = $row["pname"];
                    $field9name = $row["description"];
