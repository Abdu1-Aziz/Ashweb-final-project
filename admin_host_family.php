        ...
        <?php 
             ...
             echo '<table class="table" border="0" cellspacing="2" cellpadding="2">
                  <thead class="thead-dark">
                    <tr>
                      ...
                      <th scope="col"><font face="Arial">Country</font></th>
                      <th scope="col"><font face="Arial">Hometown</font></th>
                      <th scope="col"><font face="Arial">Family Name</font></th>
            ...
            if ($result = mysqli_query($conn, $query)) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    $field8name = $row["country"];
                    $field9name = $row["hometown"];
                    $field10name = $row["family_name"];
                    $field11name = $row["description"];
